...
public class StationDhammermk1guiGui extends Hydrexium116ModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public StationDhammermk1guiGui(Hydrexium116ModElements instance) {
		super(instance, 64);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("station_dhammermk_1gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, StationDhammermk1guiGuiWindow::new));
	}
