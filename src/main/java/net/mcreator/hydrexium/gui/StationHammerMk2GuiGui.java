...
import net.mcreator.hydrexium.procedures.StationHammerMk2Procedure;
...
public class StationHammerMk2GuiGui extends Hydrexium116ModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("station_hammer_mk_2_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, StationHammerMk2GuiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				Hydrexium116Mod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
		...
		if (buttonID == 0) {
			{
				...
				StationHammerMk2Procedure.executeProcedure($_dependencies);
			}
		}
	}
