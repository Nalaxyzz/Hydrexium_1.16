...
public class MineraisdeFauconiumBlock extends Hydrexium116ModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mineraisde_fauconium");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hydrexium_1_16:mineraisde_fauconium_match"),
			...
			event.getRegistry().register(feature.setRegistryName("mineraisde_fauconium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:mineraisde_fauconium"), configuredFeature);
		}
	}
	@SubscribeEvent
