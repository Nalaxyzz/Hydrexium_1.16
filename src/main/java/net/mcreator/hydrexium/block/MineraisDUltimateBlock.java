...
public class MineraisDUltimateBlock extends Hydrexium116ModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minerais_d_ultimate");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(UltimateGemItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hydrexium_1_16:minerais_d_ultimate_match"),
			...
			event.getRegistry().register(feature.setRegistryName("minerais_d_ultimate"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:minerais_d_ultimate"), configuredFeature);
		}
	}
	@SubscribeEvent
