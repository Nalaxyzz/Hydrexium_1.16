...
public class MineraisdinfinityBlock extends Hydrexium116ModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mineraisdinfinity");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hydrexium_1_16:mineraisdinfinity_match"),
			...
			event.getRegistry().register(feature.setRegistryName("mineraisdinfinity"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:mineraisdinfinity"), configuredFeature);
		}
	}
	@SubscribeEvent
