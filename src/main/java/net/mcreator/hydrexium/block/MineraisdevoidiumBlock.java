...
public class MineraisdevoidiumBlock extends Hydrexium116ModElements.ModElement {
	@ObjectHolder("hydrexium_1_16:mineraisdevoidium")
	public static final Block block = null;
	public MineraisdevoidiumBlock(Hydrexium116ModElements instance) {
		super(instance, 21);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mineraisdevoidium");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hydrexium_1_16:mineraisdevoidium_match"),
			...
			event.getRegistry().register(feature.setRegistryName("mineraisdevoidium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:mineraisdevoidium"), configuredFeature);
		}
	}
	@SubscribeEvent
