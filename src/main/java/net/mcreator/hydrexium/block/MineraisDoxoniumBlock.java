...
public class MineraisDoxoniumBlock extends Hydrexium116ModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minerais_doxonium");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hydrexium_1_16:minerais_doxonium_match"),
			...
			event.getRegistry().register(feature.setRegistryName("minerais_doxonium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:minerais_doxonium"), configuredFeature);
		}
	}
	@SubscribeEvent
