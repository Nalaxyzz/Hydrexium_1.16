...
public class MineraisDinferniumBlock extends Hydrexium116ModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minerais_dinfernium");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hydrexium_1_16:minerais_dinfernium_match"),
			...
			event.getRegistry().register(feature.setRegistryName("minerais_dinfernium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:minerais_dinfernium"), configuredFeature);
		}
	}
	@SubscribeEvent
