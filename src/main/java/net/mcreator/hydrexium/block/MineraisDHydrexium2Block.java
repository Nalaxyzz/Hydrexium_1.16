...
public class MineraisDHydrexium2Block extends Hydrexium116ModElements.ModElement {
	@ObjectHolder("hydrexium_1_16:minerais_d_hydrexium_2")
	public static final Block block = null;
	public MineraisDHydrexium2Block(Hydrexium116ModElements instance) {
		super(instance, 10);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minerais_d_hydrexium_2");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hydrexium_1_16:minerais_d_hydrexium_2_match"),
			...
			event.getRegistry().register(feature.setRegistryName("minerais_d_hydrexium_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:minerais_d_hydrexium_2"),
					configuredFeature);
		}
	}
	@SubscribeEvent
