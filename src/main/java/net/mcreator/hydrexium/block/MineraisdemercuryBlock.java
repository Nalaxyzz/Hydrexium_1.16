...
public class MineraisdemercuryBlock extends Hydrexium116ModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mineraisdemercury");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hydrexium_1_16:mineraisdemercury_match"),
			...
			event.getRegistry().register(feature.setRegistryName("mineraisdemercury"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:mineraisdemercury"), configuredFeature);
		}
	}
	@SubscribeEvent
