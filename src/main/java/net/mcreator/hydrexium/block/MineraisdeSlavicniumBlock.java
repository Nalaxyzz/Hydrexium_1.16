...
public class MineraisdeSlavicniumBlock extends Hydrexium116ModElements.ModElement {
	@ObjectHolder("hydrexium_1_16:mineraisde_slavicnium")
	public static final Block block = null;
	public MineraisdeSlavicniumBlock(Hydrexium116ModElements instance) {
		super(instance, 18);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mineraisde_slavicnium");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hydrexium_1_16:mineraisde_slavicnium_match"),
			...
			event.getRegistry().register(feature.setRegistryName("mineraisde_slavicnium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:mineraisde_slavicnium"), configuredFeature);
		}
	}
	@SubscribeEvent
