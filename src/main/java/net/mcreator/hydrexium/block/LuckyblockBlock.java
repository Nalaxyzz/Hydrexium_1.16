...
import net.mcreator.hydrexium.procedures.LuckyblockcasseProcedure;
...
public class LuckyblockBlock extends Hydrexium116ModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				LuckyblockcasseProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
