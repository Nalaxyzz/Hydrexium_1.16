...
public class HydrexiumFlowerBlock extends Hydrexium116ModElements.ModElement {
	@ObjectHolder("hydrexium_1_16:hydrexium_flower")
	public static final Block block = null;
	public HydrexiumFlowerBlock(Hydrexium116ModElements instance) {
		super(instance, 44);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("hydrexium_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hydrexium_1_16:hydrexium_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("hydrexium_flower");
		}
