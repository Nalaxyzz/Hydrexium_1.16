...
public class SourisEntity extends Hydrexium116ModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8500971, -764979, new Item.Properties().group(HydrexiumtabItemGroup.tab))
				.setRegistryName("souris_spawn_egg"));
	}
