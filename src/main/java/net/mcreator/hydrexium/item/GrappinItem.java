...
import net.mcreator.hydrexium.entity.renderer.GrappinRenderer;
import net.mcreator.hydrexium.Hydrexium116ModElements;

import java.util.Random;

@Hydrexium116ModElements.ModElement.Tag
public class GrappinItem extends Hydrexium116ModElements.ModElement {
	@ObjectHolder("hydrexium_1_16:grappin")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(HydrexiumtabItemGroup.tab).maxDamage(100));
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(TetedegrappinItem.block, (int) (1));
		}
