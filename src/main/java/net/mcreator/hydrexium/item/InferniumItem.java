...
public class InferniumItem extends Hydrexium116ModElements.ModElement {
	@ObjectHolder("hydrexium_1_16:infernium_helmet")
	public static final Item helmet = null;
	@ObjectHolder("hydrexium_1_16:infernium_chestplate")
	public static final Item body = null;
	@ObjectHolder("hydrexium_1_16:infernium_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(HydrexiumtabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "hydrexium_1_16:textures/models/armor/inferniun_.png__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("infernium_helmet"));
		...
		}.setRegistryName("infernium_chestplate"));
		...
		}.setRegistryName("infernium_leggings"));
		...
		}.setRegistryName("infernium_boots"));
	}
}
